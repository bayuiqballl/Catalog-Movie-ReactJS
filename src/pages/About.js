...
const About = () => {
    return (
        <div>
                        ...
                        <div className="col text-center pt-5">
                            ...
                            <div className="row">
                                <div className="col">
                                    ...
                                    <p>Turpis egestas integer eget aliquet  
                                        praesent tristique magna sit.  
                                        mauris pellentesque pulvinar.</p>
                                </div>
                                <div className="col">
                                    <h4><strong>OUR MISSIONS</strong></h4>
                                    <p>Turpis egestas integer eget aliquet  
                                        praesent tristique magna sit.  
                                        mauris pellentesque pulvinar.</p>
                                </div>
            ...
            <div className="container-fluid mt-5" style={{backgroundColor:"#E40004"}}>
                <div className="container">
                    <div className="row">
                        <div className="col py-5 text-center">
                            <h2 className="text-white"><strong>SELECTION OF HIGH QUALITY FILMS</strong></h2>
                            <hr/>
                            <p className="text-white py-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col pb-5">
                            <h2 className="text-center pt-5"><strong>MOVIE GENRES</strong></h2>
                            <hr/>
                            <div className="row pt-5">
                                <div className="col">
                                    <p className="text-danger"><strong>Fantasy</strong></p>
                                    <p>Turpis egestas integer eget aliquet  
                                    praesent tristique magna sit.  
                                    mauris pellentesque pulvinar.</p>
                                </div>
                                <div className="col">
                                    <p className="text-danger"><strong>Action Movie</strong></p>
                                    <p>Turpis egestas integer eget aliquet  
                                    praesent tristique magna sit.  
                                    mauris pellentesque pulvinar.</p>
                                </div>
                                <div className="col">
                                    <p className="text-danger"><strong>Crime</strong></p>
                                    <p>Turpis egestas integer eget aliquet  
                                    praesent tristique magna sit.  
                                    mauris pellentesque pulvinar.</p>
                                </div>
                            ...
                            <div className="row mt-4 pb-5">
                                <div className="col">
                                <p className="text-danger"><strong>Biographical</strong></p>
                                    <p>Turpis egestas integer eget aliquet  
                                    praesent tristique magna sit.  
                                    mauris pellentesque pulvinar.</p>
                                </div>
                                <div className="col">
                                <p className="text-danger"><strong>Military</strong></p>
                                    <p>Turpis egestas integer eget aliquet  
                                    praesent tristique magna sit.  
                                    mauris pellentesque pulvinar.</p>
                                </div>
                                <div className="col">
                                <p className="text-danger"><strong>Adventure</strong></p>
                                    <p>Turpis egestas integer eget aliquet  
                                    praesent tristique magna sit.  
                                    mauris pellentesque pulvinar.</p>
                                </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col py-5">
                            <h2 className="text-center"><strong>OUR FANTASTIC TEAM</strong></h2>
                            <hr/>
